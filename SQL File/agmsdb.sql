...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2024 at 06:16 AM
...
(6, 'tdt', 'test', 'Potrait', 'Small', 2, 4, 11, 2500, 'hfdchcjyhfvjcjtdjhcjy', '6dfe8354f0f8d8d2fe2fde10612516361727419419.jpg', 'a3.jpg', '', '', '', 312167875, '2024-09-27 06:43:39'),
(7, 'Silhouette Photo of Trees', 'Silhouette Photo of Trees', 'Potrait', 'Medium', 2, 3, 8, 2500, 'My first bronze African elephant sculpture, Follow Me, depicting the tender bond between mother and baby, is now sold out. But if you missed out don’t worry. I’ve been hard at work on a new African elephant sculpture in bronze. This time I’ve chosen the African bull elephant as my subject. Giant of the Plains is ready to be sent to the foundry for casting and is available for pre-order now.', '14d9c239b9ea127986fe14e3fa16df791727496158.jpg', '', '', '', '', 851546956, '2024-09-28 04:02:38');
