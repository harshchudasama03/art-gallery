                  ...
                  <div class="container">
                     <div class="slider-info ">
                        ...
                        <div class="bottom-info">
                           <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.Aenean commodo ligula eget dolorL
                              orem ipsum dolor sit amet eget dolor</p>
                        </div>
   ...
   <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
         ...
         <div class="row banner-below-w3l">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
               <img src="images/a6.jpg" width="200" height="200" class="img-thumbnail" alt="">
               <div class="banner-right-icon">
               ...
               ?>
                  <li>
                     ...
                     <div class="agileinfo_port_grid">
                        <img src="admin/images/<?php echo $row['Image']; ?>" width=250 height=250 alt=" "
                           class="" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">
